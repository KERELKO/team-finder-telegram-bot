...
from team_bot.bot.v1.filters import GameRanksFilter, ListFilter
from team_bot.bot.v1.utils import get_user_or_end_conversation
from team_bot.infra.utils import parse_telegram_webpage
from team_bot.infra.di import Container
from team_bot.domain.utils import get_game_by_id, get_game_by_name
from team_bot.domain.entities.games.base import BaseGame, GameCollection
from team_bot.domain.entities.users import Team, User, GameData
...
class CollectUserDataConversation(BaseConversationHandler):
    ...
    async def start_conversation(cls, update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
        games = Container.resolve(GameCollection)
